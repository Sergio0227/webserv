...
Location::Location(Location &ref)
{
...
void Location::setAutoindex(std::string& autoindex)
{
    ...
    if (set)
        throw Config::ConfigException("Duplicate Autoindex declaration, only one allowed per server block");
...
void Location::setIndex(std::string& index)
{
    static bool set = false;
    if (set)
        throw Config::ConfigException("Duplicate Index declaration, only one allowed per server block");
...
void Location::setClientMaxBodySize(std::string& client_max_body_size)
{
    static bool set = false;
    if (set)
        throw Config::ConfigException("Duplicate ClientMaxBodySize declaration, only one allowed per server block");
...
void Location::setAlias(std::string& alias)
{
    static bool set = false;
    if (set)
        throw Config::ConfigException("Duplicate Alias declaration, only one allowed per server block");
...
void Location::setRoot(std::string& root)
{
    static bool set = false;
    if (set)
        throw Config::ConfigException("Duplicate Root declaration, only one allowed per server block");
...
void Location::setReturnValue(std::string& return_value)
{
    static bool set = false;
    if (set)
        throw Config::ConfigException("Duplicate ReturnValue declaration, only one allowed per server block");
...
void Location::setAllowedMethods(std::string& allowed_methods)
{
    static bool set = false;
    if (set)
        throw Config::ConfigException("Duplicate AllowedMethods declaration, only one allowed per server block");
